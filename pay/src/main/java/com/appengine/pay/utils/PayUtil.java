...
import com.appengine.pay.utils.PayConfig.SignType;
...
public class PayUtil {
    ...
    public static String createSign(SortedMap<String, String> parameters, String wxApiKey) throws Exception {
        ...
        sb.append("key=" + wxApiKey);//最后加密时添加商户密钥，由于key值放在最后，所以不用添加到SortMap里面去，单独处理，编码方式采用UTF-8
