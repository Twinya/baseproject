...
public class IPUtils {
    ...
    public static final String ipRegix = "((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)";
    public static final Pattern ipPattern = Pattern.compile(ipRegix);
    ...
    public static String getLocalIp() {
        ...
        List<String> faceNames = new ArrayList<>(ips.keySet());
    ...
    public static void main(String[] args) {
        System.out.println(ipToInt("223.104.210.108"));
    }
