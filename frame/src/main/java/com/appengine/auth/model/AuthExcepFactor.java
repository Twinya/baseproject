...
public class AuthExcepFactor extends ExcepFactor {
    ...
    public static final AuthExcepFactor E_AUTH_PASSWORD_ERROR = new AuthExcepFactor(
            HttpStatus.UNAUTHORIZED, 2, "password error!", "密码不正确");
    public static final AuthExcepFactor E_AUTH_USERNAME_ERROR = new AuthExcepFactor(
            HttpStatus.UNAUTHORIZED, 28, "username not exist!", "用户不存在");
    public static final AuthExcepFactor E_AUTH_CODE_ERROR = new AuthExcepFactor(
            HttpStatus.UNAUTHORIZED, 25, "code error!", "验证码不正确");
    public static final AuthExcepFactor E_AUTH_CODE_EXPIRED = new AuthExcepFactor(
            HttpStatus.UNAUTHORIZED, 27, "code expired!", "验证码过期");
    public static final AuthExcepFactor E_AUTH_REQUEST_ERROR = new AuthExcepFactor(
            HttpStatus.UNAUTHORIZED, 26, "requestid error!", "请先发送验证码");
