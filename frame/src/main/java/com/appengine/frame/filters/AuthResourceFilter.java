...
public class AuthResourceFilter extends RequestMappingHandlerAdapter {
    ...
    @Override
    protected ModelAndView handleInternal(@Nonnull HttpServletRequest request, @Nonnull HttpServletResponse response,
...
//                || StringUtils.startsWith(request.getRequestURI(), "/v2/api-docs")
                || StringUtils.startsWith(request.getRequestURI(), "/api/configgerion")
        ...
        context.setIp(request.getHeader("x-real-ip"));
